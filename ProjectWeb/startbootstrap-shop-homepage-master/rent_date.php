...
<body style="font-family: FC Home;font-size: 24px;">
  ...
  <!-- Navigation -->
  <form method="GET" action="process_rent.php">
  ...
  <div class="container">
    <div class="col-lg-9 mt-4" ">        
        <h2> เช่ารถราคาดี กับ BT Carrent</h2>
        <hr>
    ...
    <select name="type">
              <option value="">จักรยาน</option>
              <option value="">รถยนต์</option>
              <option value="">กระบะ</option>
              <option value="">จักยานยนต์</option>
    ...
    <input type="date" id="end" name="trip-end"
       value="2018-07-22"
       min="2018-01-01" max="2018-12-31">
    <input type="submit" value="ดำเนินการต่อ">
    </div>
  ...
  <!-- Footer -->
  <footer class="py-5 bg-dark fixed-button">
    <div class="container">
